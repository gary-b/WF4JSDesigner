        ...
        return {
            ...
            initFlowchart: function (element, flowchartModel, conMenu) {
                ...
                renderWaiter.afterRender(function () {
                    ...
                    jsPlumb.setContainer($(element).find('.drop-zone'));
                    jsPlumb.addEndpoint($(element).find('.start-node'), {
            ...
            deleteConnection: function () {
                if (designerUI.selectedItem.modelType === 'flowchartPlumbConnection') {
                    jsPlumb.detach(designerUI.selectedItem.connection); //code in jsPlumb detach event will handle rest
                } else {
            ...
            cancelFlowSwitchCase: function(popupViewModel) {
                jsPlumb.detach(popupViewModel.connection); // our detach code will delete the case object
            },
            ...
            addFlowDecisionEndpoints: function(element, node) {
                ...
                function addSourceEndpoint(pos, name, labelFn) {
                    ...
                    var endpoint = jsPlumb.addEndpoint($(element), {
                        anchor: anchorPos,
                        isSource: true,
                        overlays:[
                            [ "Label", {
                ...
                if (nodes.length < this.nodeElements.length) {
                    for (var i = 0; i < this.nodeElements.length; i++) {
                        ...
                        if (pos === -1) {
                            ...
                            jsPlumb.removeAllEndpoints(this.nodeElements[i].element);
